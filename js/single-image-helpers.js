...
function resize(src){
  ...
  return new Promise(function (resolve) {
    image.onload = function () {
      ...
      dst.width = image_dimension_w;
      dst.height = image_dimension_h;
      ...
      window.pica.WW = true;
      resolve(dst.toDataURL("image/jpeg"));
    };
  });
}
...
$(document).ready( function() {
        ...
        function readURL(input) {
            if (input.files[0]) {
                ...
                preview_show.setAttribute("style","width:"+image_dimension_w+"px");
                preview_show.setAttribute("style","height:"+image_dimension_h+"px");
